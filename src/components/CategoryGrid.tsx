      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="text-xs sm:text-sm text-primary hover:underline flex items-center gap-0.5"
          >
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-2 sm:gap-3">
          {categories.map((cat) => (
            <button
              ...
              className="flex flex-col items-center gap-2 p-3 sm:p-4 rounded-xl border bg-card hover:bg-accent hover:border-primary/30 transition-all duration-200 active:scale-95 group text-center"
            >
